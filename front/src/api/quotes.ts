...
export const QuotesResponse: MessageFns<QuotesResponse> = {
  encode(message: QuotesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.profitPct !== 0) {
      writer.uint32(57).double(message.profitPct);
    }
    if (message.maxDrawdownPct !== 0) {
      writer.uint32(65).double(message.maxDrawdownPct);
    }
    if (message.wins !== 0) {
      writer.uint32(72).int32(message.wins);
    }
    if (message.losses !== 0) {
      writer.uint32(80).int32(message.losses);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.profitPct = reader.double();
          continue;
        }
        case 8: {
          if (tag !== 65) {
          ...
          message.maxDrawdownPct = reader.double();
          continue;
        }
        case 9: {
          if (tag !== 72) {
  ...
  fromPartial(object: DeepPartial<QuotesResponse>): QuotesResponse {
    ...
    message.profitPct = object.profitPct ?? 0;
    message.maxDrawdownPct = object.maxDrawdownPct ?? 0;
